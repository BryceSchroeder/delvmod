...
class ReDelv(object):
    ...
    def __init__(self):
        ...
        menu_items = (
            ...
            ("/Tools/Use Specific Editor/_Prop List",
                 (lambda *argv: self.specific_ed("PropList")),None,0,None),
            ("/Tools/Use Specific Editor/_Map",
                 (lambda *argv: self.specific_ed("Map")),None,0,None),
